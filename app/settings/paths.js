...
class AppPaths {
    ...
    static install() {
        ...
        for (let path of this.#paths) {
            if (process.platform === "win32" && path.includes("java")) {
    ...
    static MAIN_FOLDER_ANDROID = this.#paths[0]
    static ANDROID_SDK = this.#paths[1];
    static AVD_DIR = this.#paths[2]
    static DOWNLOADS_DIR = this.#paths[3]
    // Только для Windiws
    static JAVA_DIR = this.#paths[4]
}
